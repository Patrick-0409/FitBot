                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            TextFieldd(label: 'Weight (kg)', controller: _weightController,
                              keyboardType: TextInputType.number,
                              size:size,validator: _requiredWeight,),
                            const SizedBox(height: 15),
                            Spacer(),
                            TextFieldd(label: 'Height (cm)', controller: _heightController,
                              keyboardType: TextInputType.number,
                              size:size,validator: _requiredHeight,),
                          ],
                        )
                      ],
                    ),
